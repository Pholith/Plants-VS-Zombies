...
import fr.umlv.zen5.KeyboardKey;
	...
	public final class GameManager {
	    ...
	    private long lastSecTime;	//Sauvegarde du temps de d�marage pour du comptage des fps
	    private long lastFrameTime;	//Sauvegarde du temps de la derniere frame
	    
	    private float deltaTime;	//Temps �coul� entre la frame actuelle et celle d'avant
	    private float timeScale;	//Vitesse g�nerale du jeu
		...
		/* TODO
		 * Renvoie le premier objet ennemi � l'objet
		 * Renvoie null sinon
		 */ 
		...
		public void endGame(boolean win) {
			...
			new UI_Label(new Vector2(1f, 1f), (win)?"Partie gagn�e !":"Partie perdue !", (win)?Color.green :Color.red, 5f);
